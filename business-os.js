...
(function () {
  ...
  const PAGES = [
    ...
    { id: 'content-planner', label: 'Content Planner', href: 'content-planner.html', group: 'Marketing',
    ...
    { id: 'publishing-calendar', label: 'Publishing Calendar', href: 'publishing-calendar.html', group: 'Marketing',
      icon: '<rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line>' },
    { id: 'asset-library', label: 'Asset Library', href: 'asset-library.html', group: 'Marketing',
    ...
    { id: 'workflow-monitor', label: 'Workflow Monitor', href: 'workflow-monitor.html', group: 'Operations',
      icon: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>' },
    { id: 'analytics', label: 'Analytics', href: 'analytics.html', group: 'Operations',
      icon: '<line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line>' },
    { id: 'prompt-library', label: 'Prompt Library', href: 'prompt-library.html', group: 'Operations',
      icon: '<polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line>' },
    { id: 'settings', label: 'Settings', href: 'settings.html', group: 'System',
  ...
  function renderWorkflowHealthGrid(container, workflows, opts) {
    ...
    container.innerHTML = workflows.map((w) => `
      <a class="health-card" href="workflow-monitor.html" style="${w.state === 'error' ? 'border-color:var(--status-danger-text);' : ''}">
  ...
  function initGlobalSearch() {
    ...
    function search(query) {
      ...
      results.innerHTML =
        group('Content', content, 'content-planner.html', '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>') +
        group('Prompts', prompts, 'prompt-library.html', '<polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line>') +
        group('Workflows', workflows, 'workflow-monitor.html', '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>') +
        group('Assets', assets, 'asset-library.html', '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline>');
      results.classList.add('open');
    }
